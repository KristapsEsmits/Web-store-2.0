      ...
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Categories
            <router-link class="btn btn-primary btn-round btn-fill float-end excel-btn" to="/admin/categories/create">Add Category</router-link>
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-auto">
              ...
              <tbody>
                <tr v-for="(category, index) in categories" :key="index">
                  <td><input type="checkbox" v-model="selectedRows" :value="category"></td>
                  <td>{{ category.id }}</td>
          ...
          <div class="d-block d-md-none">
            ...
            <div v-for="(category, index) in categories" :key="index" class="card mb-3">
              <div class="card-body">
                <h5 class="card-title"><input class="checkbox-btn" type="checkbox" v-model="selectedRows" :value="category">{{ category.category_name }}</h5>
